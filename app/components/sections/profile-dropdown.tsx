  ...
  return (
    <>
      ...
      >
        <DropdownTrigger>
          <User
            ...
            name={
              <p className="hidden md:block text-slate-200 font-nunito text-xs">
                {"user?.email"}
              </p>
            }
          />
      ...
      <ConfirmModal
        ...
        actionText="Sure, logout"
        handleSubmit={() => {
          navigate("/login");
        }}
      >
        <p className="font-nunito font-medium text-slate-800 dark:text-white">
