  ...
  return (
    <div
      className={`w-full flex ${
        author?._id === author?._id ? "justify-end" : "justify-start"
      }`}
    >
      <div className="flex gap-2.5">
        ...
        <div className="grid">
          ...
          <div className="w-max max-w-2xl grid">
            <div
              className="px-3.5 py-2 bg-gray-100 dark:bg-slate-800 rounded-3xl rounded-tl-none justify-start  items-center gap-3 inline-flex flex-wrap text-wrap font-nunito text-sm"
