    ...
    <div className="h-full flex flex-col gap-2">
      ...
      <div className="flex items-center font-nunito font-semibold gap-2">
        <Button
          ...
          color="primary"
          variant={`${
            location.pathname === "/lab-technician/medical-requests"
              ? "flat"
              : "light"
          }`}
          onPress={() => navigate("/lab-technician/medical-requests")}
        >
          Personal Requests
        </Button>
        {user.permissions.includes("request_for_others") && (
          <Button
            ...
            color="primary"
            variant={`${
              location.pathname === "/lab-technician/medical-requests/on-behalf"
                ? "flat"
                : "light"
            }`}
            onPress={() =>
              navigate("/lab-technician/medical-requests/on-behalf")
            }
          >
            Requests for Others
          </Button>
...
export const meta: MetaFunction = () => {
  return [
    { title: "Medical Requests | Staff | Adamus Med Treatment" },
    {
      name: "description",
      content: ".",
    },
