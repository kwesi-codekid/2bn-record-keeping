    ...
    <div className="h-full flex flex-col gap-2">
      ...
      <div className="flex items-center font-nunito font-semibold gap-2">
        <Button
          ...
          color="primary"
          variant={`${
            location.pathname === "/staff/medical-requests" ? "flat" : "light"
          }`}
          onPress={() => navigate("/staff/medical-requests")}
        >
          Personal Requests
        </Button>
        {user.permissions.includes("request_for_others") && (
          <Button
            ...
            color="primary"
            variant={`${
              location.pathname === "/staff/medical-requests/on-behalf"
                ? "flat"
                : "light"
            }`}
            onPress={() => navigate("/staff/medical-requests/on-behalf")}
          >
            Requests for Others
          </Button>
        )}
