    ...
    <div className="h-full flex flex-col gap-2">
      ...
      <div className="flex items-center font-nunito font-semibold gap-2">
        <Button
          ...
          color="primary"
          variant={`${
            location.pathname === "/manager/medical-requests" ? "flat" : "light"
          }`}
          onPress={() => navigate("/manager/medical-requests")}
        >
          Personal Requests
        </Button>
        {user.permissions.includes("request_for_others") && (
          <Button
            ...
            color="primary"
            variant={`${
              location.pathname === "/manager/medical-requests/on-behalf"
                ? "flat"
                : "light"
            }`}
            onPress={() => navigate("/manager/medical-requests/on-behalf")}
          >
            Requests for Others
          </Button>
        )}
        {(user.permissions.includes("approve_request") ||
          ...
          <Button
            ...
            color="primary"
            variant={`${
              location.pathname === "/manager/medical-requests/approvals"
                ? "flat"
                : "light"
            }`}
            onPress={() => navigate("/manager/medical-requests/approvals")}
          >
            Approvals
          </Button>
        )}
