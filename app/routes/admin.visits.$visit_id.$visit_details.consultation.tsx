      ...
      */}
      ...
      <Form method="post" id="consultation-form">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          <CustomTextarea label="Consultation" name="consultation" />
          <CustomTextarea label="Complaints" name="complaints" />
          <CustomTextarea label="Investigation" name="investigation" />
          <CustomTextarea label="Disposition" name="disposition" />
          <CustomTextarea label="Treatment" name="treatment" />
          ...
          <CustomSelect
            ...
            name="work_status"
            options={workStatus}
            value={getValuesFromSet(selectedWorkStatus)}
            renderValue={(items) => {
              return (
                <div className="flex flex-wrap gap-2">
                  {items.map((item: any) => (
          ...
          <CustomInput
            ...
            type="number"
          />
          <CustomDatePicker label="Review Date" name="reviewDate" />
          <CustomInput label="Referred To" name="referredTo" />
          <Checkbox
            name="detained"
