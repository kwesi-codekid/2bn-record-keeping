          ...
          <Card className="flex flex-col gap-3 py-5 px-4 rounded-3xl dark:bg-slate-900/80 bg-white shadow-none">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 flex flex-col gap-1">
                ...
                <p className="text-xs font-nunito">{visit.staff.staffId}</p>
                <p className="text-xs font-nunito">{visit.staff.email}</p>
                <p className="text-xs font-nunito">{visit.staff?.phone}</p>
              </div>
            </div>
          </Card>
                ...
                >
                  ...
                  <div className="w-[20%] flex items-center">
                    <Button
                      ...
                      onPress={() =>
                        navigate(`/admin/visits/${visit_id}/${visit?._id}`)
                      }
                    >
                      Details
                    </Button>
