...
import { nurseNavLinks } from "~/data/nav-links";
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-2 p-2">
          {nurseNavLinks.map((link: AdminNavLinkInterface, index: number) => {
            return (
              <NavLink
                key={index}
                to={link.path}
        ...
        <div className="flex flex-col gap-2">
          ...
          <header className="bg-indigo-600 flex items-center justify-between py-1 px-4 md:pl-2 rounded-2xl">
            <div className="flex items-center gap-3 ">
              ...
              <NavHeader navLinks={nurseNavLinks} basePath="/nurse" />
            </div>
...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  await userController.checkUserRole("nurse");
